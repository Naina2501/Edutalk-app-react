  ...
  return (
    <div className='contact'>
        <div className="contact-col">
         <h3>Send us a message <span className='bi bi-send-fill'></span></h3>
         <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati aliquam eveniet doloremque inventore excepturi? Vitae temporibus molestiae beatae cupiditate amet natus repellat obcaecati, itaque, iure ut atque dolorem dignissimos quo.
        ...
        <label>Your Name</label>
         ...
         <textarea name='message' id="" cols="30" rows="10" required ></textarea>
           ...
           <button className=' fw-bold  nav-btn' type='submit' >Contact-Us<span className='bi bi-arrow-right mx-2'></span></button>
      </form>
      <span>{result}</span>
      </div>   
    </div>
